...
import {dailyBriefWorkflow} from '../fixtures/daily-brief.mjs'
test('WebKit daily safety brief: draft recovery, immutable briefing, acknowledgement, export and Actions',async({browser})=>{
 ...
 await dailyBriefWorkflow({browser,origin:APP_ORIGIN,actors,options:{...devices['iPhone 13'],localOnly:true}})
})
