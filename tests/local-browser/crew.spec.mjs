...
import {crewWorkflow} from '../fixtures/crew.mjs'
test('WebKit crew coordination: personal work, version responses, reassignment and access boundaries',async({browser})=>{
 ...
 await crewWorkflow({browser,origin:APP_ORIGIN,actors,options:{...devices['iPhone 13'],localOnly:true}})
})
