...
export async function renderExport(job,photos) {
 ...
 try{
  ...
  if(report.site_snapshot){line('Site name captured: '+report.site_snapshot.name);line('Site detail revision: '+report.site_snapshot.revision);line('Site instructions captured (company supplied): '+(report.site_snapshot.instructions||'None recorded'))}
