...
export default function ReportTools({report,canAmend}) {
 ...
 return <div className="no-print work-panel"><button onClick={()=>window.print()}>Print this record</button><p>Browser printing is available for review. Payments and paid access are unavailable while trusted billing reconciliation is rebuilt.</p>
