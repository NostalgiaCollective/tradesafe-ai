...
try {
  ...
  assert.equal(result.status, 'passed'); assert.equal(result.executed, 9); assert.equal(result.skipped, 0)
  console.log('PASS: 9 executed WebKit local-integration tests; zero skipped. No hosted/email-delivery/physical-device claim.')
