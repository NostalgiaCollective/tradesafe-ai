...
try {
  ...
  assert.equal(result.status, 'passed'); assert.equal(result.executed, 4); assert.equal(result.skipped, 0)
  console.log('PASS: 4 executed WebKit local-integration tests; zero skipped. No hosted/email-delivery/physical-device claim.')
